...
//		$('.choose').each(function(){this.checked = false;});
//		$('#tableTotal tbody').remove();
//		$('#tableTotal').append(stringTotal);
//		if(dataChartTotal1.length!=0){
//			$crm.pieChart('dataChartTotal1', dataChartTotal1, '', 'name', 'impression');
//		}
//		if(dataChartTotal2.length!=0){
//			$crm.pieChart('dataChartTotal2', dataChartTotal2, '', 'name', 'click');
//		}
//		
//		if(typeData==2)			$crm.lineChartOne('dataChartTotal3', dataChartTotal3, '','name','click',format);
//		else if(typeData == 3) 	$crm.lineChartWeek('dataChartTotal3', dataChartTotal3, '','name','click');
//		else if(typeData == 4)	$crm.lineChartMonth('dataChartTotal3', dataChartTotal3, '','name','click');
//		console.log(format);
